...
function draw_instrument_frames(){
	min = schwierigkeiten[spielStatus.schwierigkeit].startTuningRange*-1;
	max = schwierigkeiten[spielStatus.schwierigkeit].startTuningRange;
	step = schwierigkeiten[spielStatus.schwierigkeit].step;
	$(".SpielFlaeche").text("");
